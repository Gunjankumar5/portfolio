  ...
  return (
    <section className="about" id="about">
      <div className="about-container">
        <h2>About Me</h2>
        <p>
          I'm Gunjan Kumar, a passionate and energetic second-year B.Tech Computer Science student at Sharda University, with a strong foundation in core engineering principles and a growing command of modern technologies.
        </p>
        <p>
